---
title: "User Guide: 3 Debugging ggplots"
...
The 'ggpmisc' package also defines a `"null"` geom, which is used as default by the _debug_ _stats_ described above. Currently this geom is similar to the recently added `ggplot2::geom_blank()`.
