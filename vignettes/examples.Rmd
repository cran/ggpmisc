...
Some of them are more generaly useful, such as `stat_poly_eq()`, but others
...
The default locations are now based on normalized coordinates, and conswquently
...
Experimental! Use ggplot2::stat_smooth() instead.
